...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers(HttpMethod.POST, "/api/users/login", "/api/users/**", "/api/homeReservations/searchFree", "/api/homes/filterHomes", "/api/boats/filterBoats", "/api/adventures/filterAdventures", "/api/adventuresReservation/searchFree", "/api/boatReservations/searchFree");

...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers(HttpMethod.POST, "/api/users/login", "/api/users/client/register", "/api/users/house-owner/register",
                "/api/homes/filterHomes", "/api/users/boat-owner/register", "/api/users/activate/**");
